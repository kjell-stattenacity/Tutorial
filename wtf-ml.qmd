...
sample1_sg_1_2_15 <-
  processed_data %>%
  dplyr::filter(sample_id == 1 & differentiation_order == 1 & polynomial_order == 2 & window_size == 15) %>%
  pivot_longer(cols= -c(concentration, sample_id, differentiation_order, polynomial_order, window_size), names_to="wavelength", values_to="value") %>%
  dplyr::select(value)
...
sample1_sg_2_2_15 <-
  processed_data %>%
  dplyr::filter(sample_id == 1 & differentiation_order == 2 & polynomial_order == 2 & window_size == 15) %>%
  pivot_longer(cols= -c(concentration, sample_id, differentiation_order, polynomial_order, window_size), names_to="wavelength", values_to="value") %>%
  dplyr::select(value)
...
sample1_sg_1_2_49 <-
  processed_data %>%
  dplyr::filter(sample_id == 1 & differentiation_order == 1 & polynomial_order == 2 & window_size == 49) %>%
  pivot_longer(cols= -c(concentration, sample_id, differentiation_order, polynomial_order, window_size), names_to="wavelength", values_to="value") %>%
  dplyr::select(value)
...
sample1_sg_2_2_49 <-
  processed_data %>%
  dplyr::filter(sample_id == 1 & differentiation_order == 2 & polynomial_order == 2 & window_size == 49) %>%
  pivot_longer(cols= -c(concentration, sample_id, differentiation_order, polynomial_order, window_size), names_to="wavelength", values_to="value") %>%
  dplyr::select(value)
