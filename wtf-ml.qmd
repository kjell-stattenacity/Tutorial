...
The samples with the largest residuals were `r knitr::combine_words(worst_resid_ids)`.
...
all_pred_most %>% 
  ...
  geom_point(data = all_pred_34, col = "red", pch = 17, cex = 4, alpha = 1 / 2) + 
  geom_point(data = all_pred_7, col = "blue", pch = 15, cex = 4, alpha = 1 / 2) + 
